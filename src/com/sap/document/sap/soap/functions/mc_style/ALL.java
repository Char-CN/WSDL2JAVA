...
public final class ALL {
	...
	public static void main(String args[]) throws java.lang.Exception {
		...
		String imDays = "1";
		String fName = SourceUtil.root + "data/" + imDate + "_" + imDays + ".csv";
		if (args.length >= 1) {
			imDate = args[0];
			if (imDate.indexOf("-") == -1) {
		...
		ZshrJfpernr jfpernr2 = new ZshrJfpernr();
		fw.write(jfpernr2.toFields() + "	dimension2	dimention1\n");
		fw.write(jfpernr2.toFieldsInfo() + "	新增维度2	新增维度1\n");
		{
